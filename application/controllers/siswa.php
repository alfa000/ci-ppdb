...
class Siswa extends CI_Controller {
	...
	{
    if($this->session->userdata('aktivasi') != 'N'){
        redirect('siswa/tampil_siswa');
    }
	...
	public function simpan_psb(){
        ...
        $this->load->library('upload', $config);
         ...
         $noreg = $this->input->post('no_reg');
          ...
          'nil1' => $this->input->post('nil1')[$key],
          'nil2' => $post['nil2'][$key],
          'nil3' => $post['nil3'][$key],
          'nil4' => $post['nil4'][$key],
          'nil5' => $post['nil5'][$key],
          'nil_ratarata' => $post['nil_ratarata'][$key],
          );
          }
